...
<div class="container">
	...
	<div class="row clearfix">
		<div class="col-md-4 column">
			...
			<form action="<?php echo site_url('jurusan/cekLogin');?>" method="post" role="form">
				<div class="form-group">
                   <p class="glyphicon glyphicon-user"></p> <label>Username</label>
                    ...
                    <p class="glyphicon glyphicon-import"></p> <label>Jurusan</label>
                    <select required class="form-control input-sm" name="kode_jurusan">Pilih Jurusan
		...
		<div class="col-md-8 bg-active">
			<div class="jumbotron well">
				<h2 class="text-primary">
					SIAP Online- Ketua Jurusan
				</h2>
				<p class="text-justify">
                 <table class="table table-condensed">
                        <tr><td><li> Informasi Umum</li></td><td><li>Entry Nilai</li></td></tr>
                        <tr><td><li> Setting Kurikumlum</li></td><td><li>Kelola KRS</li></td></tr>
                    <tr><td> <li>Disposisi Perwalian</li></td><td><li> Kelola KHS</li></td></tr>
                    <tr><td><li>  Cek Perwalian</li></td><td><li>Cek Daftar Nilai Sementara</li></td></tr>
                     <tr><td><li>  Ubah Detail Akun</li></td><td></td></tr>
                    </table>
				</p>
				<p>
